...
import 'comp_app_home_page_model.dart';
export 'comp_app_home_page_model.dart';

class CompAppHomePageWidget extends StatefulWidget {
  const CompAppHomePageWidget({Key? key}) : super(key: key);

  @override
  _CompAppHomePageWidgetState createState() => _CompAppHomePageWidgetState();
}

class _CompAppHomePageWidgetState extends State<CompAppHomePageWidget>
    with TickerProviderStateMixin {
  late CompAppHomePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompAppHomePageModel());
